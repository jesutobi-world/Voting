...
const Changed = () => {
  return (
    <div className="h-screen w-screen flex flex-col-reverse lg:flex-row-reverse items-center justify-center relative">
        ...
        <div className='flex items-center justify-center w-full min-h-[300px] lg:h-full lg:w-1/2 bg-blue-700 p-10 grow'>
            <img src={ChangedImage} alt="" className='object-cover w-[90%] h-fll' />
        </div>
    </div>
);
}
